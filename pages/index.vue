...
.homepage #workflow h4, .homepage #workflow p {
    max-width: 670px;
    margin-left: auto;
    margin-right: auto;
    color: #979797;
...
#workflow .graph .circle .central {
    height: 10px;
    width: 10px;
    border: 1px solid #fff;
    border-radius: 10px;
}
#workflow .graph .central, #workflow .graph .circle {
    display: flex;
    justify-content: center;
    align-items: center;
}
#workflow .graph .circle .central .inner {
    height: 2px;
    width: 2px;
    border-radius: 2px;
