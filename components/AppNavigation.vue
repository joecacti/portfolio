        ...
        <a v-scroll-to="{el:'#header', offset: -80}" href="/#header">
          ...
          >
            <g class="group">
              ...
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M346.58,122.85l-.08,14.62H270.12V4.84H346.5V19.47H286.9V63.52h48.27V77.59H286.9v45.26Z" transform="translate(-5 -3.36)" />
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M436.46,84.63v52.84H419.68V84.63L461.37,9a10,10,0,0,1,2.16-2.87,5,5,0,0,1,3.55-1.3h14.79Z" transform="translate(-5 -3.36)" />
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M588.09,122.39v15.08H517.77V4.84h16.69V122.39Z" transform="translate(-5 -3.36)" />
              ...
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M1132.08,122.39v15.08h-70.32V4.84h16.69V122.39Z" transform="translate(-5 -3.36)" />
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M1247,122.85l-.08,14.62h-76.38V4.84h76.38V19.47h-59.6V63.52h48.26V77.59h-48.26v45.26Z" transform="translate(-5 -3.36)" />
              <path class="fill-current text-gray-600 group-hover:text-orange-500 transition-colors duration-300" d="M1336.83,84.63v52.84H1320V84.63L1274.63,4.84h14.71A5.12,5.12,0,0,1,1292.88,6a10,10,0,0,1,2.25,3Z" transform="translate(-5 -3.36)" />
            </g>
          </svg>
        </a>
      </div>
      <div class="user-action-buttons">
        <a v-scroll-to="'#workflow'" href="#" class="px-4 text-sm font-semibold text-gray-600 hover:text-orange-500 hidden md:inline-flex transition-colors duration-300">Workflow</a>
        <a v-scroll-to="'#portfolio'" href="#" class="px-4 text-sm font-semibold text-gray-600 hover:text-orange-500 hidden md:inline-flex transition-colors duration-300">Portfolio</a>
        <a v-scroll-to="'#about'" href="#" class="px-4 text-sm font-semibold text-gray-600 hover:text-orange-500 hidden md:inline-flex transition-colors duration-300">About</a>
